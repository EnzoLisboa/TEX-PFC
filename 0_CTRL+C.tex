...
\begin{table}[htb]
  ...
  \begin{tabular}{m{6cm}ccccccc} % l=Left(textos); r=Right(números); o comando m{6cm} fixa a primeira coluna em 6cm, faz quebra de linha e centraliza as demais colunas na vertical
    \Linha % linha grossa
    {\bf CRONOGRAMA PFC-2023} & {\bf Fev} & {\bf Mar}  & {\bf Abr} & {\bf Mai} & {\bf Jun} & {\bf Jul} & {\bf Ago} \\
    \Linha % linha grossa      
    Levantamento Bibliográfico & X &   &   &   &   &   &  \\
    \hline % linha fina
    Alinhamento da Proposta    & X &   &   &   &   &   &  \\
    \hline % linha fina
    Projeto da Máquina de 
    Desentortar Bananas        & X & X & X &   &   &   &  \\
    \hline % linha fina
    Montagem e Experimentos    &   & X & X & X & X &   &  \\
    \hline % linha fina
    Levantamento de Dados  
    das Bananas Desempenadas,   
    ...
    e testes                   &   &   &   &    & X & X &  \\
    \hline % linha fina
    Veja que aqui irá criar
    uma longa quebra de linha
    na coluna e as demais 
    colunas ficarão 
    centralizadas              &   &   & X &  X & X & X &  \\
    \hline % linha fina
    Escrita da monografia      &   &   &   &    & X & X &  \\
    \hline % linha fina
    Escrita o Artigo a ser
    submetido à Revista
    {\it IEEE Transaction on 
    Bananas}                   &   &   &   &    & X & X & X \\
    \hline % linha fina
